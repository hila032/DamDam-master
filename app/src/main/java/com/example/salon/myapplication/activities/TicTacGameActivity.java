...
import com.example.salon.myapplication.models.TicTacGameController;
...
//        board.setValueInGame(Integer.valueOf(rowTag),Integer.valueOf(colTag),TicTacGameController.getCurrentPlayerValue(player));
    ...
    public void reset (View v) {
        newGame();
        board.setAllButtonsInGame(true);
        //String scoor = "x- " + TicTacGameController.getX() + " 0-" + TicTacGameController.get0() + " Tie-" + TicTacGameController.getTie();
    ...
    private void newGame(){
        TicTacGameController.newGame(roomId);
